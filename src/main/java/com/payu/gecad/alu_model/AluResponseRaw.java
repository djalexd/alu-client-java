...
import com.payu.gecad.alu_model.WireAccountRaw;
...
@javax.xml.bind.annotation.XmlRootElement(name = "EPAYMENT") @javax.xml.bind.annotation.XmlAccessorType(javax.xml.bind.annotation.XmlAccessType.FIELD)
public class AluResponseRaw {
  ...
  public enum STATUSEnum {
    ...
    public String toString() {
  	...
  	public static STATUSEnum byValue(String s) {
			return Stream.of(values())
				.filter(e -> e.value.equals(s))
        .findAny()
        .orElseThrow(() -> new IllegalArgumentException(String.format("Cannot find STATUSEnum byValue %s", s)));
		}
  ...
  @SerializedName("DATE")
	    @javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter(UTCDateTimeAdapter.class)
    private OffsetDateTime DATE = null;

  @SerializedName("URL_3DS")
	    @javax.xml.bind.annotation.XmlElement(name = "URL_3DS")
  ...
  **/
  ...
  public AluResponseRaw RETURN_CODE(String RETURN_CODE) {
   ...
   * @return RETURN_CODE
  **/
  @ApiModelProperty(example = "null", value = "All the possible codes")
