...
import com.payu.gecad.alu_model.AluPaymentOption;
import com.payu.gecad.alu_model.Billing;
import com.payu.gecad.alu_model.Delivery;
import com.payu.gecad.alu_model.Merchant;
import com.payu.gecad.alu_model.OrderItem;
import com.payu.gecad.alu_model.Shipping;
...
public class AluRequest {
  ...
  public enum PayMethodEnum {
    ...
    public String toString() {
  	...
  	public static PayMethodEnum byValue(String s) {
			return Stream.of(values())
				.filter(e -> e.value.equals(s))
        .findAny()
        .orElseThrow(() -> new IllegalArgumentException(String.format("Cannot find PayMethodEnum byValue %s", s)));
		}
  ...
  **/
  ...
  public AluRequest clientTime(OffsetDateTime clientTime) {
