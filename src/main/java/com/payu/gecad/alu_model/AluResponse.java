...
import com.payu.gecad.alu_model.WireAccount;
...
public class AluResponse {
  ...
  public enum ReturnCodeEnum {
    ...
    public String toString() {
  	...
  	public static ReturnCodeEnum byValue(String s) {
			return Stream.of(values())
				.filter(e -> e.value.equals(s))
        .findAny()
        .orElseThrow(() -> new IllegalArgumentException(String.format("Cannot find ReturnCodeEnum byValue %s", s)));
		}
