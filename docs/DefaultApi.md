 ...
 **BILL_CITYPE** | **String**| Shopper&#39;s ID type - mandatory for UPT. Accepted values: * PERSONALID (identity card), * PASSPORT (passport), * DRVLICENSE (driving license)  | [optional] [enum: PERSONALID, PASSPORT, DRVLICENSE]
 **BILL_CINUMBER** | **String**| Shopper&#39;s ID number (for the specified ID type)  | [optional]
 ...
 **SELECTED_INSTALLMENTS_NUMBER** | **Integer**| The number of installments. It can be an integer between 1 and 12.  | [optional]
 **CARD_PROGRAM_NAME** | **String**| The name of card program that allows paying an order using installments.  | [optional]
 **ORDER_TIMEOUT** | **Integer**| The time in seconds after which the order will expire.  | [optional]
